...
const Form = ({ onCreateUser, onUserCreated }) => {
  ...
  const handleFormSubmit = (values, { resetForm }) => {
    ...
    // Kullanıcı oluşturulduğunda ana bileşene bildirdik.
    //onUserCreated fonksiyonun gerçek bir fonksiyon olup olmadıpını kont ettik.
    if (onUserCreated && typeof onUserCreated === "function") {
      onUserCreated(newUser);
    }

    // Kullanıcı bilgilerini localStorage'a ekledik.
